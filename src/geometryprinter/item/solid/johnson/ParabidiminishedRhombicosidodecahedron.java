...
public class ParabidiminishedRhombicosidodecahedron extends ItemFractured{
    private int size;
    public ParabidiminishedRhombicosidodecahedron(){
        this(0);
    }
    public ParabidiminishedRhombicosidodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Parabidiminished Rhombicosidodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof ParabidiminishedRhombicosidodecahedron){
             if(size==((ParabidiminishedRhombicosidodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new ParabidiminishedRhombicosidodecahedron(size);
    }
    @Override
