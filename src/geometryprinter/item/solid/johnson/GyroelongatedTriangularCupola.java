...
public class GyroelongatedTriangularCupola extends ItemFractured{
    private int size;
    public GyroelongatedTriangularCupola(){
        this(0);
    }
    public GyroelongatedTriangularCupola(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Gyroelongated Triangular Cupola";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof GyroelongatedTriangularCupola){
             if(size==((GyroelongatedTriangularCupola) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new GyroelongatedTriangularCupola(size);
    }
    @Override
