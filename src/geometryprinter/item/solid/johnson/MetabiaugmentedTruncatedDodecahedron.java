...
public class MetabiaugmentedTruncatedDodecahedron extends ItemFractured{
    private int size;
    public MetabiaugmentedTruncatedDodecahedron(){
        this(0);
    }
    public MetabiaugmentedTruncatedDodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Metabiaugmented Truncated Dodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof MetabiaugmentedTruncatedDodecahedron){
             if(size==((MetabiaugmentedTruncatedDodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new MetabiaugmentedTruncatedDodecahedron(size);
    }
    @Override
