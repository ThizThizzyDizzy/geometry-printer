...
public class ParabiaugmentedTruncatedDodecahedron extends ItemFractured{
    private int size;
    public ParabiaugmentedTruncatedDodecahedron(){
        this(0);
    }
    public ParabiaugmentedTruncatedDodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Parabiaugmented Truncated Dodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof ParabiaugmentedTruncatedDodecahedron){
             if(size==((ParabiaugmentedTruncatedDodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new ParabiaugmentedTruncatedDodecahedron(size);
    }
    @Override
