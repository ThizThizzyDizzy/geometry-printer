...
public class ParabigyrateRhombicosidodecahedron extends ItemFractured{
    private int size;
    public ParabigyrateRhombicosidodecahedron(){
        this(0);
    }
    public ParabigyrateRhombicosidodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Parabigyrate Rhombicosidodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof ParabigyrateRhombicosidodecahedron){
             if(size==((ParabigyrateRhombicosidodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new ParabigyrateRhombicosidodecahedron(size);
    }
    @Override
