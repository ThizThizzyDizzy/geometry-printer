...
public class TriangularCupola extends ItemFractured{
    private int size;
    public TriangularCupola(){
        this(0);
    }
    public TriangularCupola(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Triangular Cupola";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof TriangularCupola){
             if(size==((TriangularCupola) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new TriangularCupola(size);
    }
    @Override
