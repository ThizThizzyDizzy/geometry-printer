...
public class ParagyrateDiminishedRhombicosidodecahedron extends ItemFractured{
    private int size;
    public ParagyrateDiminishedRhombicosidodecahedron(){
        this(0);
    }
    public ParagyrateDiminishedRhombicosidodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Paragyrate Diminished Rhombicosidodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof ParagyrateDiminishedRhombicosidodecahedron){
             if(size==((ParagyrateDiminishedRhombicosidodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new ParagyrateDiminishedRhombicosidodecahedron(size);
    }
    @Override
