...
public class MetabiaugmentedDodecahedron extends ItemFractured{
    private int size;
    public MetabiaugmentedDodecahedron(){
        this(0);
    }
    public MetabiaugmentedDodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Metabiaugmented Dodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof MetabiaugmentedDodecahedron){
             if(size==((MetabiaugmentedDodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new MetabiaugmentedDodecahedron(size);
    }
    @Override
