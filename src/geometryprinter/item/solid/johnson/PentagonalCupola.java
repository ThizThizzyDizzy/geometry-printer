...
public class PentagonalCupola extends ItemFractured{
    private int size;
    public PentagonalCupola(){
        this(0);
    }
    public PentagonalCupola(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Pentagonal Cupola";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof PentagonalCupola){
             if(size==((PentagonalCupola) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new PentagonalCupola(size);
    }
    @Override
