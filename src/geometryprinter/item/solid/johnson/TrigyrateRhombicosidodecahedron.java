...
public class TrigyrateRhombicosidodecahedron extends ItemFractured{
    private int size;
    public TrigyrateRhombicosidodecahedron(){
        this(0);
    }
    public TrigyrateRhombicosidodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Trigyrate Rhombicosidodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof TrigyrateRhombicosidodecahedron){
             if(size==((TrigyrateRhombicosidodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new TrigyrateRhombicosidodecahedron(size);
    }
    @Override
