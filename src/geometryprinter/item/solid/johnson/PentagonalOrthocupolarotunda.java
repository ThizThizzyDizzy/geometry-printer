...
public class PentagonalOrthocupolarotunda extends ItemFractured{
    private int size;
    public PentagonalOrthocupolarotunda(){
        this(0);
    }
    public PentagonalOrthocupolarotunda(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Pentagonal Orthocupolarotunda";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof PentagonalOrthocupolarotunda){
             if(size==((PentagonalOrthocupolarotunda) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new PentagonalOrthocupolarotunda(size);
    }
    @Override
