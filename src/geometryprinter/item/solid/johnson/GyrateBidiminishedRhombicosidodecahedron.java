...
public class GyrateBidiminishedRhombicosidodecahedron extends ItemFractured{
    private int size;
    public GyrateBidiminishedRhombicosidodecahedron(){
        this(0);
    }
    public GyrateBidiminishedRhombicosidodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Gyrate Bidiminished Rhombicosidodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof GyrateBidiminishedRhombicosidodecahedron){
             if(size==((GyrateBidiminishedRhombicosidodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new GyrateBidiminishedRhombicosidodecahedron(size);
    }
    @Override
