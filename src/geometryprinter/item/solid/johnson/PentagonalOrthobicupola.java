...
public class PentagonalOrthobicupola extends ItemFractured{
    private int size;
    public PentagonalOrthobicupola(){
        this(0);
    }
    public PentagonalOrthobicupola(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Pentagonal Orthobicupola";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof PentagonalOrthobicupola){
             if(size==((PentagonalOrthobicupola) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new PentagonalOrthobicupola(size);
    }
    @Override
