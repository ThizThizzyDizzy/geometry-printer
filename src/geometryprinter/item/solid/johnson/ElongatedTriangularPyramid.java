...
public class ElongatedTriangularPyramid extends ItemFractured{
    private int size;
    public ElongatedTriangularPyramid(){
        this(0);
    }
    public ElongatedTriangularPyramid(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Elongated Triangular Pyramid";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof ElongatedTriangularPyramid){
             if(size==((ElongatedTriangularPyramid) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new ElongatedTriangularPyramid(size);
    }
    @Override
