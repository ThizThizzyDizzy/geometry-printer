...
public class MetabidiminishedIcosahedron extends ItemFractured{
    private int size;
    public MetabidiminishedIcosahedron(){
        this(0);
    }
    public MetabidiminishedIcosahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Metabidiminished Icosahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof MetabidiminishedIcosahedron){
             if(size==((MetabidiminishedIcosahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new MetabidiminishedIcosahedron(size);
    }
    @Override
