...
public class GyrateRhombicosidodecahedron extends ItemFractured{
    private int size;
    public GyrateRhombicosidodecahedron(){
        this(0);
    }
    public GyrateRhombicosidodecahedron(int size){
        this.size = size;
    }
    @Override
    public String getDisplayName(){
        return size+" Pixel Gyrate Rhombicosidodecahedron";
    }
    @Override
    ...
    public boolean isEqual(Item item){
        if(item instanceof GyrateRhombicosidodecahedron){
             if(size==((GyrateRhombicosidodecahedron) item).size){
                 return true;
             }
        }
        return false;
    ...
    public PageObject replicate(){
        return new GyrateRhombicosidodecahedron(size);
    }
    @Override
